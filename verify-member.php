...
<head>
    ...
    <link rel="stylesheet" href="public/css/style-pw.css">
</head>
<body>
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="verify-member.php" method="POST" autocomplete="off">
                    <div class="form-group">
                        <input class="form-control" type="hidden" name="username" value="<?= $username ?>">
                    </div>
                    <h2 class="text-center">Code Verification Account</h2>
                    <?php 
