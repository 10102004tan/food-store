...
class Product extends Database{
    ...
    public function getAllProductByKeyLimit($key,$page,$perPage){
        $sql = parent::$connection->prepare("SELECT products.*, menus.name as 'menu_name' FROM `products`  inner join menus on products.menu_id = menus.id where products.name like ? LIMIT ?,? ");
        $key = "%" . $key . "%";
