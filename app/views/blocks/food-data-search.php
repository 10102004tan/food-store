            ...
            <ul class="pagination">
                ...
                <?php for ($i = 1; $i <= $endPage; $i++): ?>
                    <li class="page-item <?= ($page == $i) ? "active" : "" ?>">
                        <a class="page-link" href="find.php?page=<?= $i ?>&&key=<?= $key ?>">
                            <?= $i ?>
                        </a>
                    </li>
                <?php endfor ?>
        ...
        btn.addEventListener("click", (event) => {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    console.log(data)
                    console.log(inputMenuIdEdit)
                    inputMenuIdEdit.forEach((input) => {
                        if (input.value == data.menu_id) {
                            input.checked = true;
                            input.previousElementSibling.classList.toggle("btn-warning");
                    ...
                    images.forEach((img) => {
                        ...
                        imgTag.setAttribute("src", "../../public/storage/" + img);
