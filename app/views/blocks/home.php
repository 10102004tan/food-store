...
<section class="section-slide">
    <div class="wrap-slick1">
        <div class="slick1">
            <div class="item-slick1 item1-slick1" style="background-image: url(public/images/slide1-01.jpg);">
        ...
        <div class="row">
            ...
            <div class="col-md-6 p-b-30">
                <div class="wrap-pic-welcome size2 bo-rad-10 hov-img-zoom m-l-r-auto">
                    <img src="public/images/our-story-01.jpg" alt="IMG-OUR">
                </div>
            </div>
        </div>
    </div>
...
<section class="section-intro">
    <div class="header-intro parallax100 t-center p-t-135 p-b-158"
        style="background-image: url(public/images/bg-intro-01.jpg);">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 p-t-30">
                    ...
                    <div class="blo1">
                        <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
                            <a href="#"><img src="public/images/intro-01.jpg" alt="IMG-INTRO"></a>
                        </div>
                ...
                <div class="col-md-4 p-t-30">
                    ...
                    <div class="blo1">
                        <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
                            <a href="#"><img src="public/images/intro-02.jpg" alt="IMG-INTRO"></a>
                        </div>
                ...
                <div class="col-md-4 p-t-30">
                    ...
                    <div class="blo1">
                        <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
                            <a href="#"><img src="public/images/intro-04.jpg" alt="IMG-INTRO"></a>
                        </div>
...
<section class="section-event">
    <div class="wrap-slick2">
        <div class="slick2">
            <div class="item-slick2 item1-slick2" style="background-image: url(public/images/bg-event-01.jpg);">
                    ...
                    <div class="container">
                        ...
                        <div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="zoomIn">
                            ...
                            <a href="#" class="wrap-pic-blo2 bg1-blo2"
                                style="background-image: url(public/images/event-02.jpg);">
            ...
            <div class="item-slick2 item2-slick2" style="background-image: url(public/images/bg-event-02.jpg);">
                <div class="wrap-content-slide2 p-t-115 p-b-208">
                    <div class="container">
                        <!-- - -->
                        <div class="title-event t-center m-b-52">
                        ...
                        <div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false"
                            ...
                            <a href="#" class="wrap-pic-blo2 bg2-blo2"
                                style="background-image: url(public/images/event-06.jpg);">
                                <div class="time-event size10 txt6 effect1">
            ...
            <div class="item-slick2 item3-slick2" style="background-image: url(public/images/bg-event-04.jpg);">
                <div class="wrap-content-slide2 p-t-115 p-b-208">
                    <div class="container">
                        <!-- - -->
                        <div class="title-event t-center m-b-52">
                        ...
                        <div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false"
                            ...
                            <a href="#" class="wrap-pic-blo2 bg3-blo2"
                                style="background-image: url(public/images/event-01.jpg);">
                                <div class="time-event size10 txt6 effect1">
                                    <span class="txt-effect1 flex-c-m">
                                        08:00 PM Tuesday - 21 November 2018
                                    </span>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 p-b-30 p-t-18">
                <div class="wrap-pic-booking size2 bo-rad-10 hov-img-zoom m-l-r-auto">
                    <img src="public/images/booking-01.jpg" alt="IMG-OUR">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="wrap-content-slide3 p-b-50 p-t-50">
                    <div class="container">
                        <div class="pic-review size14 bo4 wrap-cir-pic m-l-r-auto animated visible-false"
                            data-appear="zoomIn">
                            <img src="public/images/avatar-01.jpg" alt="IGM-AVATAR">
                        </div>

                        <div class="content-review m-t-33 animated visible-false" data-appear="fadeInUp">
                            <p class="t-center txt12 size15 m-l-r-auto">
                                â We are lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean tellus sem,
                                mattis in pre-tium nec, fermentum viverra dui â
                            </p>
            ...
            <div class="item-slick3 item2-slick3">
                <div class="wrap-content-slide3 p-b-50 p-t-50">
                    <div class="container">
                        <div class="pic-review size14 bo4 wrap-cir-pic m-l-r-auto animated visible-false"
                            data-appear="zoomIn">
                            <img src="public/images/avatar-04.jpg" alt="IGM-AVATAR">
                        </div>
            ...
            <div class="item-slick3 item3-slick3">
                <div class="wrap-content-slide3 p-b-50 p-t-50">
                    <div class="container">
                        <div class="pic-review size14 bo4 wrap-cir-pic m-l-r-auto animated visible-false"
                            data-appear="zoomIn">
                            <img src="public/images/avatar-05.jpg" alt="IGM-AVATAR">
                        </div>
...
<!-- Video -->
<section class="section-video parallax100" style="background-image: url(public/images/bg-cover-video-02.jpg);">
