            ...
            <?php foreach($reservations_data as $reservation_data): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-primary me-2 btn-status-reservation" value="1" type="button" data-id="<?=$reservation_data['id'] ?>" >Approved</button>
                        <button class="btn btn-danger me-2 btn-status-reservation" type="button" value="2" data-id="<?=$reservation_data['id'] ?>" >Cancelled</button>
                        </div>
                </tr>
            <?php endforeach ?>
        </tbody>
